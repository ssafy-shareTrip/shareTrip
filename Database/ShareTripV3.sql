...
CREATE TABLE IF NOT EXISTS `sharetrip`.`board_memo` (
  ...
  `regist_time` DATETIME NOT NULL,
  INDEX `fk_memo_board1_idx` (`board_no` ASC) VISIBLE,
  INDEX `fk_memo_user1_idx` (`user_id` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `sharetrip`.`trip_attraction` (
  ...
  PRIMARY KEY (`trip_no`, `content_id`),
...
-- -----------------------------------------------------
-- Table `sharetrip`.`trip_fav`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `sharetrip`.`trip_fav` (
  `user_id` VARCHAR(45) NOT NULL,
  `trip_no` VARCHAR(45) NOT NULL,
  `category` INT NOT NULL,
  `bookmark_time` DATETIME NOT NULL,
  PRIMARY KEY (`user_id`, `trip_no`),
  INDEX `fk_user_has_user_trip_user_trip1_idx` (`trip_no` ASC) VISIBLE,
  ...
  CONSTRAINT `fk_user_has_user_trip_user1`
    ...
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_user_has_user_trip_user_trip1`
    FOREIGN KEY (`trip_no`)
    REFERENCES `sharetrip`.`user_trip` (`trip_no`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
-- -----------------------------------------------------
-- Table `sharetrip`.`trip_memo`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `sharetrip`.`trip_memo` (
  `trip_no` VARCHAR(45) NOT NULL,
  `user_id` VARCHAR(45) NOT NULL,
  `content` VARCHAR(1000) NOT NULL,
  `regist_time` DATETIME NOT NULL,
  ...
  INDEX `fk_user_trip_has_user_user_trip1_idx` (`trip_no` ASC) VISIBLE,
  CONSTRAINT `fk_user_trip_has_user_user_trip1`
    FOREIGN KEY (`trip_no`)
    REFERENCES `sharetrip`.`user_trip` (`trip_no`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
