        ...
        <div
            ...
            <span v-for="fav in store.favs" :key="fav.favId">
                <span v-show="fav.favId != element.contentId && fav.category === 0">
                    <img :src="`/public/icon/like_false.png`" width="15" @click="f1"></span >
                    <span v-show="fav.favId == element.contentId && fav.category === 0">
                        <img :src="`/public/icon/like_true.png`" width="15"></span >
                        <span v-show="fav.favId != element.contentId && fav.category === 1">
                            <img :src="`/public/icon/star_false.png`" width="15"></span>
                            <span v-show="fav.favId == element.contentId && fav.category === 1">
                                <img :src="`/public/icon/star_true.png`" width="15"></span>
                            </span>
